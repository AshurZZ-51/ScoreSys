...
const REVIEW_STATUS_OPTIONS = [
  ...
  { value: 'r1_rejected', label: '第一轮不通过', color: '#dc2626', bg: '#fee2e2' },
  ...
  { value: 'r2_rejected', label: '第二轮不通过', color: '#dc2626', bg: '#fee2e2' },
...
const MATERIAL_ITEMS = [
  ...
  { key: 'mvp_plan', label: 'MVP制作计划', required: true },
