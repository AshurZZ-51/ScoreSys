...
test('computes innovation as median of selected levels scaled to 40 points', () => {
  const scores = [
    { reviewer_code: 'N', dim_name: 'r1::创新性::level', score: 8 },
    { reviewer_code: 'S', dim_name: 'r1::创新性::level', score: 40 },
    { reviewer_code: 'J', dim_name: 'r1::创新性::level', score: 20 },
    { reviewer_code: 'G', dim_name: 'r1::创新性::level', score: 28 },
    { reviewer_code: 'W', dim_name: 'r1::创新性::level', score: 12 }
  ];
