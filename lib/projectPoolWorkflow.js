...
const MATERIAL_ITEMS = [
  ...
  { item_key: 'operations_metrics', label: '运营考核指标（初版）', required: true },
  { item_key: 'virtual_team', label: '虚拟团队资源配置（初步）', required: true },
...
function createMaterialRows(projectId, initialStatuses = {}, checkedBy = null, checkedAt = null) {
...
function buildMaterialUpsert(projectId, itemKey, required, status, note, checkedBy, checkedAt) {
  return { project_id: projectId, item_key: itemKey, required, status, note, checked_by: checkedBy, checked_at: checkedAt };
}
