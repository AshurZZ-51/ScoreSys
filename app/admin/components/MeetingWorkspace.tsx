...
function renderBlindStats(round: Item) {
  ...
  const verdictText = verdict?.submittedCount ? `结论 通过 ${verdict.counts.approved || 0} (${verdict.percentages?.approved || 0}%) · 重评 ${verdict.counts.recheck || 0} (${verdict.percentages?.recheck || 0}%) · 驳回 ${verdict.counts.rejected || 0} (${verdict.percentages?.rejected || 0}%)` : '';
